...
import "./About.css"
import aboutImg from "../assets/gTwdOSbB-kohinoor-sapphire-1.jpeg"

const About = () => {
  return (
    <div className='about-cont d-flex align-items-center' id="about">
        <div>
        <div><h1 className='text-center p-3'>About Us</h1></div>
        <div className='p-4'>
            <p>
            ...
            <p>
            Transparency and integrity are at the core of the company's values. With a customer-centric approach, Kohinoor Developers Pune ensures open communication and timely delivery of projects, earning the trust and loyalty of their customers.
            </p>
        </div>
        </div>
    </div>
